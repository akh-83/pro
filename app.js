...
const tr = {
  'Pyc': {
    ...
    instrNorm: [
        ...
        {t: 'Калькулятор', c: 'Введите количество штук, время на 1 штуку (из чертежа), время начала и окончания. Нажмите "Рассчитать", чтобы увидеть процент.'},
        {t: 'Рабочее время (RCP)', c: 'Ваш табель рабочего времени. При входе открывается смена, де потрібно вказати номер.'}
    ],
