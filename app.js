const SUPABASE_URL = 'https://apnmlbvefruhagufmpfc.supabase.co';
            ...
            async function apiCall(action, payload = {}) {
                if (!supabase) return { status: 'error', message: 'No Supabase' };
            ...
            const tr = {
              ...
              'Ukr': {
                ...
                admin: { title: 'Панель Адміністратора', back: 'Вийти з профілю', users: 'Користувачі', resetData: 'Скинути дані', resetConfirm: 'Видалити ВСІ локальні данные? Дія незворотня!', resetSuccess: 'Дані скинуто! Перезапуск...', deleteAll: 'Видалити всіх', deleteUser: 'Видалити', deleteConfirm: 'Ви впевнені? Дія незворотня!' },
            ...
            function openSaveModal(isEdit, idx) {
                ...
                document.getElementById('savePosNumber').value = rec.pos || "";
            ...
            function confirmSave() {
                ...
                const posVal = document.getElementById('savePosNumber').value;
