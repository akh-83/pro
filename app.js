...
async function loadAdminUsers() {
    ...
    let uHtml = "<h2 style='color:#fff; margin-bottom:5px;'>" + t.admin.title + "</h2><p style='color:#8b949e; margin-top:0;'>" + t.admin.users + ": " + adminUsersList.length + "</p><div class='admin-grid'>";
